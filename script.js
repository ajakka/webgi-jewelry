...
async function setupViewer() {
  ...
  viewer.scene.setBackground(new Color(BACKGROUND_COLOR).convertSRGBToLinear());
  ...
  function toggleNightMode() {
    if (!nightMode) {
      ...
      viewer.scene.setBackground(new Color("#22052F").convertSRGBToLinear());
      nightMode = true;
    } else {
      ...
      viewer.scene.setBackground(
        new Color(BACKGROUND_COLOR).convertSRGBToLinear()
      );
      nightMode = false;
    }
  }
